import { Controller, Get, Post, Res, Param, NotFoundException, HttpStatus } from "@nestjs/common";
...
export class ClubController {
  ...
  // async addClubInfo(@Res() res) {
  //   const club = await this.clubService.addClubInfo();
  // }
